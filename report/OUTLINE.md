...
4. Extensions and innovations (Section 4 opens with an innovation map - Table 5 -
   that states every extension and points to its evidence; the fusion test and
   its honest negative result are the worked example inside this section).
